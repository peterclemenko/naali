...
macro(link_package_bullet)
    if (IS_DIRECTORY ${BULLET_DIR}/lib/Release) # prebuilt deps package and svn checkout cmake build
        if (WIN32)
            target_link_libraries(${TARGET_NAME} debug ${BULLET_DIR}/lib/Debug/LinearMath_Debug.lib)
            target_link_libraries(${TARGET_NAME} debug ${BULLET_DIR}/lib/Debug/BulletDynamics_Debug.lib)
            target_link_libraries(${TARGET_NAME} debug ${BULLET_DIR}/lib/Debug/BulletCollision_Debug.lib)
